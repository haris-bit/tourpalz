            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Doctor About</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Edit Doctor About</li>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Doctor About</h4>
                                @include('dashboard.layouts.partials.flash-message')


                                <form class="m-t-40" novalidate action="{{ route('admin.doctor_about.update', $doctor_about->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h5>Dr Name <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                            <input type="text" name="name" class="form-control" required value="{{$doctor_about->name}}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="title" class="form-control" required value="{{$doctor_about->title}}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <textarea class="form-control" rows="5" name="description">{{$doctor_about->description}}</textarea>
                            ...
                            <div class="slim" data-ratio="512,512" data-min-size="512,512" data-force-size="512,512"
                                 data-force-min-size="false"

                                 data-size="512,512">
                                 @if(isset($doctor_about->image))
                                        <img src="{{URL::to( 'public/doctor_about_image/'.$doctor_about->image)}}" alt="" />
                                        @else
                                        <img src="{{URL::to('public/doctor_about_image/placeholder-512x512.png')}}" alt="" />
                                        @endif
