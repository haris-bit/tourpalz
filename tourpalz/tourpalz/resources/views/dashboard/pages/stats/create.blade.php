            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add Stat</h4>
                    </div>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Add Stat</h4>
                                @include('dashboard.layouts.partials.flash-message')
                              
                                <form class="m-t-40"  action= "{{ route('admin.stats.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf   
                                <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="lable" class="form-control" required value="{{old('lable')}}">
