            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Add Expertise</h4>
                    </div>
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40"  action= "{{ route('admin.expertises.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf   
                                <div class="row">
                                <div class="col-md-12">
                            ...
                            <div class="slim" data-ratio="512,512" data-min-size="512,512" data-force-size="512,512"
                                 ...
                                 <!-- @if(isset($user->avatar))
                                        <img src="{{URL::to( 'public/expertise_image/'.$user->avatar)}}" alt="" />
                                        @else
