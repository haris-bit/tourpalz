            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Banner</h4>
                    </div>
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="{{ route('admin.banner.update', $banner->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                    <div class="col-md-12">
                            ...
                            <div class="slim" data-ratio="1920,1080" data-min-size="1920,1080" data-force-size="1920,1080"
                                 data-force-min-size="false"

                                 data-size="1920,1080">
                                 @if(isset($banner->image))
                                        <img src="{{URL::to( 'public/banner_image/'.$banner->image)}}" alt="" />
                                        @else
                                        <img src="{{URL::to('public/banner_image/placeholder-512x512.png')}}" alt="" />
                                        @endif
