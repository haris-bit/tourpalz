                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="{{URL::to('user/ads/website/create/')}}/{{$website->id}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                        ...
                        <table id="example23" class="display nowrap table table-hover table-striped table-bordered" cellspacing="0" width="100%">
                            ...
                            @forelse ($ads as $key=> $ad)
                                        ...
                                        <td>
                                         ...
                                         <a href="{{ route('user.ads.edit',$ad->id) }}" class="btn btn-warning btn-circle"><i class="fa fa-pencil-alt"></i> </a>
