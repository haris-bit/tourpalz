            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Targeted websites</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Targeted websites</li>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Targeted websites</h4>
                               
                                <form class="m-t-40" novalidate action="{{ route('websites.update', $website->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH') 
                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="user_id" required>
                                            ...
                                            <option @if(old('user_id')==$user->id) selected @elseif($website->user_id==$user->id) selected @endif value="{{$user->id}}">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input value="{{$website->website}}" type="text" name="website" class="form-control" required data-validation-required-message="This field is required" data-validation-regex-regex="((http[s]?|ftp[s]?):\/\/)?([\da-z\.-]+)\.([a-z\.]{2,6})([\/\w \.-]*)*" data-validation-regex-message="Only Valid Websites URL's"> </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input value="{{$website->tags}}" type="text" name="tags" class="form-control"  data-role="tagsinput"  required data-validation-required-message="This field is required"  />
