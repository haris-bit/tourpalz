            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit XCELL About</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Edit XCELL About</li>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit XCELL About</h4>
                                @include('dashboard.layouts.partials.flash-message')


                                <form class="m-t-40" novalidate action="{{ route('admin.xcell_about.update', $xcell_about->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="title" class="form-control" required value="{{$xcell_about->title}}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <textarea class="form-control" rows="5" name="description">{{$xcell_about->description}}</textarea>
                            ...
                            <div class="slim" data-ratio="512,512" data-min-size="512,512" data-force-size="512,512"
                                 ...
                                 data-size="512,512">
                                 @if(isset($xcell_about->image))
                                        <img src="{{URL::to( 'public/xcell_about_image/'.$xcell_about->image)}}" alt="" />
                                        @else
                                        <img src="{{URL::to('public/xcell_about_image/placeholder-512x512.png')}}" alt="" />
                                        @endif
