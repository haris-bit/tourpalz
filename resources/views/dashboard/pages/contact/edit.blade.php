            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="{{ route('admin.contact.update', $contact->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" name="address" class="form-control" required value="{{$contact->address}}">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h5>Google Map Address <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                            <input type="text" name="google_map_address" class="form-control" required value="{{$contact->google_map_address}}">
                                            <span class="text-danger">{{ $errors->first('google_map_address') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h5>Time One <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                            <input type="text" name="time_one" class="form-control" required value="{{$contact->time_one}}">
                                            <span class="text-danger">{{ $errors->first('time_one') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h5>Time Two <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                            <input type="text" name="time_two" class="form-control" value="{{$contact->time_two}}">
                                            <span class="text-danger">{{ $errors->first('time_two') }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <h5>Time Three <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                            <input type="text" name="time_three" class="form-control" value="{{$contact->time_three}}">
                                            <span class="text-danger">{{ $errors->first('time_three') }}</span>
                                            </div>
                                        </div>
                                    </div>
