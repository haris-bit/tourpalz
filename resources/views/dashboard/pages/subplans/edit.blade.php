...
@section('content')
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Sub Plan</h4>
                    </div>
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="javascript:void(0)">Home</a></li>
                                <li class="breadcrumb-item active">Edit Sub Plan</li>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Sub Plan</h4>
                                @include('dashboard.layouts.partials.flash-message')


                                <form class="m-t-40" novalidate action="{{ route('admin.subplans.update', $subplans->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="title" class="form-control" required value="{{$subplans->title}}">
                                            <input type="hidden" name="plan_id" class="form-control" required value="{{$subplans->plan_id}}">
    ...
    @foreach ($packages as $package)
        <option value="{{ $package->id }}" {{ in_array($package->id, $subplans->package_ids) ? 'selected' : '' }}>{{ $package->title }}</option>
    @endforeach
</select>
