            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Stat</h4>
                    </div>
                ...
                <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Edit Stat</h4>
                                @include('dashboard.layouts.partials.flash-message')


                                <form class="m-t-40" novalidate action="{{ route('admin.stats.update', $stats->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        <h5>Lable <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="lable" class="form-control" required value="{{$stats->lable}}">
                                            <span class="text-danger">{{ $errors->first('lable') }}</span>
                                        </div>
                                    </div>
                                    </div>
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="value" class="form-control" required value="{{$stats->value}}">
