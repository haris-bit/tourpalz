            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 align-self-center">
                        <h4 class="text-themecolor">Edit Expertise</h4>
                    </div>
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="{{ route('admin.expertises.update', $expertise->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                <div class="col-md-12">
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="name" class="form-control" required value="{{$expertise->name}}">
                            ...
                            <div class="slim" data-ratio="512,512" data-min-size="512,512" data-force-size="512,512"
                                 ...
                                 data-size="512,512">
                                 @if(isset($expertise->image))
                                        <img src="{{URL::to( 'public/expertise_image/'.$expertise->image)}}" alt="" />
                                        @else
                                        <img src="{{URL::to('public/expertise_image/placeholder-512x512.png')}}" alt="" />
                                        @endif
