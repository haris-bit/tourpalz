            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40"  action= "{{ route('admin.blogs.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf   
                                <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" value="{{old('tags')}}" name="tags" data-role="tagsinput" placeholder="Add Tags" /> 
                            ...
                            <div class="slim" data-ratio="1200,677" data-min-size="1200,677" data-force-size="1200,677"
                                 ...
                                 <!-- @if(isset($user->avatar))
                                        <img src="{{URL::to( 'public/blog_image/'.$user->avatar)}}" alt="" />
                                        @else
                                        <img src="{{URL::to('public/blog_image/placeholder-677x677.png')}}" alt="" />
                                        @endif -->
