            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40"  action= "{{ route('admin.packages.store') }}" method="POST" enctype="multipart/form-data">
                                @csrf   
                                <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="actual_price" class="form-control" required value="{{old('actual_price')}}">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="discount_price" class="form-control" required value="{{old('discount_price')}}">
