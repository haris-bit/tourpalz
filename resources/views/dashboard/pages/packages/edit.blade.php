            ...
            <div class="container-fluid">
                ...
                <div class="card">
                            <div class="card-body">
                                ...
                                <form class="m-t-40" novalidate action="{{ route('admin.packages.update', $packages->id) }}"  method="POST" enctype="multipart/form-data">
                                @csrf
                    @method('PATCH')   
                                <div class="row">
                                <div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                <div class="form-group">
                                        <h5>Actual Price  <span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="actual_price" class="form-control" required value="{{$packages->actual_price}}">
                                ...
                                <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="discount_price" class="form-control" required value="{{$packages->discount_price}}">
