<aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                    <li> <a class=" waves-effect waves-dark" href="{{URL::to('admin/dashboard')}}" ><i class="icon-speedometer"></i><span class="hide-menu">Dashboard </a></li>
                    ...
                    @endif  
                        ...
                        <li> <a class=" waves-effect waves-dark" href="{{URL::to('admin/websites')}}" ><i class="ti-bell"></i><span class="hide-menu">Targeted Ads </a></li>
