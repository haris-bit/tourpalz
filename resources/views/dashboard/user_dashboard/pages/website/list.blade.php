 ...
 <!-- ============================================================== -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    ...
                    <div class="col-md-7 align-self-center text-right">
                        <div class="d-flex justify-content-end align-items-center">
                            ...
                            <a href="{{URL::to('user/websites/create')}}" class="btn btn-info d-none d-lg-block m-l-15"><i class="fa fa-plus-circle"></i> Create New</a>
                        </div>
                    </div>
                </div>
                <!-- ============================================================== -->
                ...
                <div class="card-body">
                    ...
                    @include('user_dashboard.layouts.partials.flash-message')
                            ...
                            @forelse ($websites as $key=> $website)
                                       ...
                                       <td>{{$website->count}}</td>
                                        ...
                                        <button type="button" class="btn btn-success btn-outline "  onclick="copyCodeClipbord('{{$website->id}}')">COPY CODE</button>    
                                         ...
                                         <td>
                                         <form action="{{ route('user.websites.destroy',$website->id) }}" method="POST">
                                         <a href="{{ route('user.websites.edit',$website->id) }}" class="btn btn-warning btn-circle"><i class="fa fa-pencil-alt"></i> </a>
                                ...
                                <a href="{{URL::to('user/ads/website')}}/{{$website->id}}" class="btn btn-success btn-circle" title="Ads List "><i class="fa fas fa-th-large"></i> </a>
                            </form>
...
$.ajax({
type:'POST',
url:"{{ route('user.website.copy.api') }}",
...
$.ajax({
type:'POST',
url:"{{ route('user.website.copy.code') }}",
data:{website_id:website_id,
_token:     '{{ csrf_token() }}'
},success:function(response){
//var text = "Example text to appear on clipboard";
